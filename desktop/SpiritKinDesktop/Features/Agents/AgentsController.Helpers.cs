...
internal sealed partial class AgentsController
{
    ...
    internal Separator CreateStyledSeparator()
    {
        ...
        if (_tryFindResource(separator, typeof(Separator)) is Style style)
        {
    ...
    {
        if (_tryFindResource(menu, typeof(ContextMenu)) is Style style)
        {
            menu.Style = style;
        }
    }
    ...
    {
        if (_tryFindResource(item, typeof(MenuItem)) is Style style)
        {
            item.Style = style;
        }
    }
